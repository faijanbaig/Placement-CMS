...
const CompanyPasswordModel = ({ isOpen, onClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.patch(`${import.meta.env.REACT_APP_BACKEND_URL}/api/v2/companies/change-company-password`, {
        oldPassword,
        newPassword,
      });
...
CompanyPasswordModel.propTypes = {
  isOpen: PropTypes.bool.isRequired,
  onClose: PropTypes.func.isRequired,
};

export default CompanyPasswordModel;
