...
const StudentProfileModal = ({ isOpen, onClose }) => {
  ...
  useEffect(() => {
    const fetchStudentDetails = async () => {
      try {
        const res = await axios.get(`https://placement-cms.onrender.com/api/v1/users/get-user`);
  ...
  const handleSave = async (e) => {
    ...
    try {
      ...
      await axios.patch(`https://placement-cms.onrender.com/api/v1/users/update-user-avatar`, formData, {
        headers: {
